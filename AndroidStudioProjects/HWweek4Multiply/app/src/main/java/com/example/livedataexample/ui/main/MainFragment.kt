...
// this is a longer version of the SAM above
...
//add this observer
        ...
        convertButton.setOnClickListener {
            ...
            if ((multiple1.text.isNotEmpty())&&(multiple2.text.isNotEmpty())) {

                viewModel.setAmount(multiple1.text.toString(),multiple2.text.toString())
                //don't need this
                //resultText.text = viewModel.getResult().toString()
